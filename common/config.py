...
argparser.add_argument('--test_path', type=str, default='/media/ssd1/hu/videos_challenge', help='Test set')
...
argparser.add_argument('--val_stride', type=int, default=3, help='Validation subsampling rate')
...
argparser.add_argument('--model', type=str, default='GazeLSTM', help='Model architecture')
...
argparser.add_argument('--trainval_opticalflow_path', type=str, default='./data/optical_flow/train_val', help='Train and val optical flow image directory')
argparser.add_argument('--test_opticalflow_path', type=str, default='/media/ssd1/hu/optical_flow/test', help='Test optical flow image directory')
argparser.add_argument('--step_size', type=int, default=5, help='step_size of lr_scheduler')
argparser.add_argument('--gamma', type=float, default=0.1, help='gamma of lr_scheduler')